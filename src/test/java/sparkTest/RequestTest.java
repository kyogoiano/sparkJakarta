...
public class RequestTest {
    ...
    final RouteMatch match = new RouteMatch(null, "/hi", "/hi", "text/html", null);
    final RouteMatch matchWithParams = new RouteMatch(null, "/users/:username", "/users/bob", "text/html", null);
