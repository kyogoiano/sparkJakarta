...
import sparkTest.examples.exception.SubclassOfBaseException;
...
public class GenericIntegrationTest {
    ...
    public static void setup() throws IOException {
        ...
        Spark.get("/templateView", (q, a) ->  new ModelAndView("Hello", "my view"), new TemplateEngine() {
            @Override
    ...
    public void filters_should_be_accept_type_aware() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/protected/resource", null, "application/json");
    ...
    public void routes_should_be_accept_type_aware() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/hi", null, "application/json");
    ...
    public void template_view_should_be_rendered_with_given_model_view_object() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/templateView", null);
        assertEquals(200, response.status);
    ...
    public void testGetBinaryHi() {
        try {
            SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/binaryhi", null);
            assertEquals(200, response.status);
            assertEquals("Hello World!", response.body);
        } catch (Throwable e) {
    ...
    public void testGetByteBufferHi() {
        try {
            SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/bytebufferhi", null);
            assertEquals(200, response.status);
            assertEquals("Hello World!", response.body);
        } catch (Throwable e) {
            throw new RuntimeException(e);
    ...
    public void testGetInputStreamHi() {
        try {
            SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/inputstreamhi", null);
            assertEquals(200, response.status);
            assertEquals("Hello World!", response.body);
        } catch (Throwable e) {
            throw new RuntimeException(e);
    ...
    public void testHiHead() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("HEAD", "/hi", null);
        assertEquals(200, response.status);
    ...
    public void testXForwardedFor() throws Exception {
        ...
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/ip", null, false, "text/html", headers);
    ...
    public void testParamAndWild() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/paramandwild/thedude/stuff/andits", null);
        assertEquals(200, response.status);
    ...
    public void testEchoParam1() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/param/shizzy", null);
        assertEquals(200, response.status);
    ...
    public void testEchoParam2() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/param/gunit", null);
        assertEquals(200, response.status);
        assertEquals("echo: gunit", response.body);
    }

    @Test
    //TODO: convert polyglot chars to a correct charset
    public void testEchoParam3() throws Exception {
        String polyglot = "?";
        String encoded = URIUtil.encodePath(polyglot);
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/param/" + encoded, null);
        assertEquals(200, response.status);
    ...
    public void testPathParamsWithPlusSign() throws Exception {
        ...
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/param/" + pathParamWithPlusSign, null);
        assertEquals(200, response.status);
    ...
    @Test
    @Disabled
    //LEGACY test only suitable with jetty configuration: https://eclipse.dev/jetty/javadoc/jetty-12/org/eclipse/jetty/http/UriCompliance.html
    ...
    @Test
    @Disabled
    //LEGACY test not available with newer jetty versions : https://eclipse.dev/jetty/javadoc/jetty-12/org/eclipse/jetty/http/UriCompliance.html
    ...
    public void testEchoParamWithUpperCaseInValue() throws Exception {
        ...
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/param/" + camelCased, null);
        assertEquals(200, response.status);
    ...
    private static void assertEchoRoute(String routePart) throws Exception {
        ...
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/tworoutes/" + routePart + "/" + expected, null);
        assertEquals(200, response.status);
    ...
    public void testEchoParamWithMaj() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/paramwithmaj/plop", null);
        assertEquals(200, response.status);
    ...
    public void testUnauthorized() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/secretcontent/whateva", null);
        assertEquals(401, response.status);
    }

    @Test
    public void testNotFound() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/no/resource", null);
        assertEquals(404, response.status);
    }

    @Test
    public void testPost() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("POST", "/poster", "Fo shizzy");
    ...
    @Test
    public void testPostViaGetWithMethodOverrideHeader() throws IOException, ParseException, URISyntaxException, ExecutionException, InterruptedException {
        Map<String, String> map = new HashMap<>();
        map.put("X-HTTP-Method-Override", "POST");
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/post_via_get", "Fo shizzy", false, "*/*", map);
    ...
    public void testPatch() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("PATCH", "/patcher", "Fo shizzy");
        LOGGER.info(response.body);
        assertEquals(200, response.status);
        assertTrue(response.body.contains("Fo shizzy"));
    }
    ...
    public void testSessionReset() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/session_reset", null);
        assertEquals(200, response.status);
    ...
    public void testExceptionMapper() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/throwexception", null);
        assertEquals("Exception handled", response.body);
    }

    @Test
    public void testInheritanceExceptionMapper() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/throwsubclassofbaseexception", null);
        assertEquals("Exception handled", response.body);
    }
    ...
    public void testNotFoundExceptionMapper() throws Exception {
        //        thrownotfound
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/thrownotfound", null);
    ...
    public void testTypedExceptionMapper() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/throwmeyling", null);
    ...
    public void path_should_prefix_routes() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/firstPath/test", null, "application/json");
        assertEquals(200, response.status);
    ...
    public void paths_should_be_nestable() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/firstPath/secondPath/test", null, "application/json");
        assertEquals(200, response.status);
    ...
    public void paths_should_be_very_nestable() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/firstPath/secondPath/thirdPath/test", null, "application/json");
        assertEquals(200, response.status);
    ...
    public void testRuntimeExceptionForDone() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/exception", null);
    ...
    public void testPostProcessBodyForFinally() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethod("POST", "/nice", "");
