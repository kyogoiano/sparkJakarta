...
public class StaticFilesTestExternal {
    ...
    public static void setup() throws IOException {
        ...
        staticFiles.enableMimeTypeGuessing();
    ...
    public void testExternalStaticFile() throws Exception {
        ...
        Assertions.assertEquals("text/html", response.headers.get("Content-Type"));
    ...
    public void testDirectoryTraversalProtectionExternal() throws Exception {
        ...
        Assertions.assertEquals(400, response.status); //NOTE: Jetty 12.0.0.8 block suspicious call
