...
public class ResourceUtilsTest {
    ...
    public void testGetFile_whenURLProtocolIsNotFile_thenThrowFileNotFoundException() throws
        ...
        Assertions.assertThrows(FileNotFoundException.class, () -> ResourceUtils.getFile(url, "My File Path"),
            "My File Path cannot be resolved to absolute file path " +
    ...
    public void testGetFile_whenURLProtocolIsFile_thenReturnFileObject() throws
                                                                         ...
                                                                         URISyntaxException {
        //given
        URL url = URI.create("file://public/file.txt").toURL();
