...
public class GenericSecureIntegrationTest {
    ...
    public void testXForwardedFor() throws Exception {
        ...
        SparkTestUtil.UrlResponse response = testUtil.doMethod("GET", "/ip", null, true, "text/html", headers);
    ...
    public void testHiHead() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethodSecure("HEAD", "/hi", null);
        assertEquals(200, response.status);
    ...
    public void testEchoParam1() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethodSecure("GET", "/shizzy", null);
        assertEquals(200, response.status);
    ...
    public void testEchoParam2() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethodSecure("GET", "/gunit", null);
        assertEquals(200, response.status);
    ...
    public void testEchoParamWithMaj() throws Exception {
        SparkTestUtil.UrlResponse response = testUtil.doMethodSecure("GET", "/paramwithmaj/plop", null);
        assertEquals(200, response.status);
    ...
    public void testUnauthorized() throws Exception {
        SparkTestUtil.UrlResponse urlResponse = testUtil.doMethodSecure("GET", "/protected/resource", null);
        assertEquals(401, urlResponse.status);
    }

    @Test
    public void testNotFound() throws Exception {
        SparkTestUtil.UrlResponse urlResponse = testUtil.doMethodSecure("GET", "/no/resource", null);
