...
public class ExceptionMapperTest {
    ...
    public void testGetInstance_whenDefaultInstanceIsNull() {
        ...
        assertEquals(
            Whitebox.getInternalState(ExceptionMapper.class, "servletInstance"), exceptionMapper);
    }
    ...
    public void testGetInstance_whenDefaultInstanceIsNotNull() {
        ...
        assertEquals(Whitebox.getInternalState(ExceptionMapper.class, "servletInstance"), exceptionMapper);
    }
}
